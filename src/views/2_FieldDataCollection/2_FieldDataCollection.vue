    ...
    <div class="record-main-container">
      ...
      <div class="form-grid">
        ...
        <div class="field">
          ...
          <div class="date-wrap">
            <input class="input date-display" :value="estimatedEntryDateText" placeholder="年/月/日" readonly
              tabindex="-1" />
            <button type="button" class="date-icon" @click="openDatePicker" aria-label="选择日期">
              <i class="fa-regular fa-calendar"></i>
            </button>
            <input ref="dateInputRef" v-model="form.estimatedEntryDate" type="date" class="date-native"
              @change="syncDateText" />
          </div>
        </div>
          ...
          <div class="section__rows">
            <div class="row">
              ...
              <div class="checks">
                ...
                <input v-model="form.structures.otherText" class="input input--mini"
                  :disabled="!form.structures.otherEnabled" placeholder="补充说明" />
              </div>
            </div>
            <div class="row">
              ...
              <div class="checks">
                ...
                <input v-model="form.buildingType.otherText" class="input input--mini"
                  :disabled="!form.buildingType.otherEnabled" placeholder="补充说明" />
              </div>
            </div>
            <div class="row">
              ...
              <div class="checks">
                ...
                <input v-model="form.buildingUsage.otherText" class="input input--mini"
                  :disabled="!form.buildingUsage.otherEnabled" placeholder="补充说明" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section form-grid__full">
          ...
          <div class="checks">
            ...
            <input v-model="form.techDocs.otherText" class="input input--mini" :disabled="!form.techDocs.otherEnabled"
              placeholder="补充说明" />
          </div>
        </div>
        ...
        <div class="section form-grid__full">
          ...
          <div class="checks">
            ...
            <input v-model="form.reportUse.otherText" class="input input--mini" :disabled="!form.reportUse.otherEnabled"
              placeholder="补充说明" />
          </div>
        </div>
        ...
        <div class="section form-grid__full">
          ...
          <div class="checks">
            ...
            <input v-model="form.siteDefects.otherText" class="input input--mini"
              :disabled="!form.siteDefects.otherEnabled" placeholder="补充说明" />
          </div>
        </div>
        ...
        <div class="section form-grid__full">
          ...
          <div class="section__rows">
            <div class="row">
              ...
              <div class="checks">
                <label class="check"><input type="checkbox" v-model="form.reportType.appraisalSafety" />
                  既有建筑安全鉴定（安全+抗震）</label>
            ...
            <div class="row">
              ...
              <div class="checks">
                <label class="check"><input type="checkbox" v-model="form.reportType.assessmentCapacity" />
                  承载能力评估</label>
        ...
        <div class="section form-grid__full">
          ...
          <div class="upload-row">
            ...
            <input ref="photoInputRef" type="file" accept="image/*" multiple class="hidden-input"
          ...
          <div class="section__rows">
            ...
            <div class="row">
              ...
              <div class="checks checks--nowrap">
                <label class="check"><input type="checkbox" v-model="form.entryDocking.support.investigationSupplies" />
                  勘察用品</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.support.helmet" /> 安全帽</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.support.reflectiveVest" />
                  反光衣</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.support.goggles" /> 护目镜</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.support.otherEnabled" />
                  其他</label>
                <input v-model="form.entryDocking.support.otherText" class="input input--mini"
                  :disabled="!form.entryDocking.support.otherEnabled" placeholder="补充说明" />
              </div>
            </div>
            <div class="row">
              <div class="row__label">甲方能否提供</div>
              <div class="checks checks--nowrap">
                <label class="check"><input type="checkbox" v-model="form.entryDocking.provide.climbStaff" />
                  登高人员</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.provide.climbCar" /> 登高车</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.provide.assistantStaff" />
                  检测辅助人员</label>
                <label class="check"><input type="checkbox" v-model="form.entryDocking.provide.otherEnabled" />
                  其他</label>
                <input v-model="form.entryDocking.provide.otherText" class="input input--mini"
                  :disabled="!form.entryDocking.provide.otherEnabled" placeholder="补充说明" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="consult-upload">
        ...
        <input ref="consultInputRef" type="file" accept=".txt,.doc,.docx,.pdf,image/*" class="hidden-input"
